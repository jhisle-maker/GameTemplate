...
namespace GT
{
	...
	private:
		DX11ApiConstantBufferWrapper(const DX11ApiConstantBufferWrapper& i_oOther) {};
		DX11ApiConstantBufferWrapper& operator=(const DX11ApiConstantBufferWrapper& i_oOther) {};
